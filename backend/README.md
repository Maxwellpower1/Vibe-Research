...
| `GET /api/market/world-indices` · `/boards` · `/board-stocks` · `/rank` · `/board-flow-intraday` · `/commodities` · `/commodity-minutes` | 全球关键指数 / 板块热点 / 成分股(腾讯pt*优先) / 个股榜单(含成交额, 新浪优先) / 分钟板块资金 / 大宗商品 | 腾讯/新浪/东财 |
