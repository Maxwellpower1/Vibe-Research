...
| 页面 | 包含的模块 / 能力 |
|---|---|
| 🇨🇳&nbsp;**A&#8288;股** | 顶栏：**复盘** / **K线** / **详情** / **公告**。整站顶栏下方横向滚动行情条（全球指数 + 黄金/原油/BTC 等商品，与驾驶舱共用 5 秒报价中心）。复盘是一屏驾驶舱（可放大面板）：**全球关键指数** / **市场板块实时热点**（行业/概念，右侧成分股可轮播）/ **实时热点 · 7×24**（财联社 / 新浪/见闻，行上产业链/宏观/政策标签 + NEW）/ **板块资金流向**（分钟累计蝴蝶图，点击筛主力净流入）/ **主力净流入排行** / **个股榜单** / **大宗商品**（期货分时 + 生意社现期/基差表）/ **涨跌分布 / 广度**（涨平跌条 + 8 档直方图 + 平均/中位，在大宗右侧）/ 涨跌停格 / 自选 / 龙虎·资金·8 条产业链。右下角悬浮球只留未读角标，点球滚到快讯格（其他页回复盘）；不再弹出列表 |
...
| 📡&nbsp;**资&#8288;讯&#8288;雷&#8288;达** | 复盘第一行右侧**快讯格**（财联社 / 新浪/见闻，产业链/宏观/政策打标 + NEW）。右下角悬浮球只显示未读角标，不再弹窗 |
