...
>
> A股 / 美股 / 期权期货、资讯雷达、自选股、我的持仓、我的研报、研究记录。把数据和功能配齐，由**你自己的 AI** 驱动投资研究。
...
| 页面 | 包含的模块 / 能力 |
|---|---|
| 🇨🇳&nbsp;**A&#8288;股** | Tab：**每日复盘**（首屏一眼 + sticky 分段：龙虎榜/资金/风险；资金含北向·板块流·**ETF 资金流**·**LPR/国债收益率**·**增减持**）· **轻量图表**（子 Tab：K线 / 详情 / 公告，详情含股东高管增减持） |
