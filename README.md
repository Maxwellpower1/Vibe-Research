...
**看板读法**：复盘页是一屏驾驶舱（桌面无需滚动，点面板放大）；手机底栏切主页面，A 股复盘/K线/详情/公告在顶下，浏览器可「添加到主屏幕」。K 线 / 详情 / 公告 / 美股 / 期权 / 套利 / 持仓走同一套深蓝青顶栏，不再切主题、不再套玻璃卡片。
