...
- **Futures daily / stock boards / live wire**: `GET /api/market/future-daily?code=nf_AU0` (Sina) · `GET /api/market/stock-boards?code=600519` (Eastmoney industry/area/concepts) · `GET /api/market/lives` (Sina 7×24, Wallstreetcn fallback; not a cockpit cell).
